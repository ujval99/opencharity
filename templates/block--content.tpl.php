...
/**
 * @file
 * Opencharity theme implementation to display a block.
 *
 * Available variables:
 ...
 *     the user module is responsible for handling the default user
 *     navigation block. In that case the class would be "block-user".
 ...
 */
?>
<div class="section__container section__container--<?php print wordwrap(strtolower($block->subject), 1, '-', 0);?>" id="section__container--<?php print wordwrap(strtolower($block->subject), 1, '-', 0);?>">
