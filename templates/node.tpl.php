...
/**
 * @file
 * Opencharity theme implementation to display a node.
 *
 * Available variables:
...
<?php else: ?>
  <div class="node--details clearfix">
<?php endif; ?>
<?php if (!$page): ?>
<div class="node--meta">
<?php endif; ?>
  <?php print render($title_prefix); ?>
    <?php if (!$page): ?>
      <h4 class="node--title <?php print $classes_array['1']; ?>--title" <?php print $title_attributes; ?>><a href="<?php print $node_url; ?>"><?php print $title; ?></a></h4>
    <?php endif; ?>
    <?php print render($title_suffix); ?>
  
    <?php if ($display_submitted): ?>
      <span class="node--submitted <?php print $classes_array['1']; ?>--submitted"><?php print $submitted; ?></span>
     <?php endif; ?>
...
<div class="node--content <?php print $classes_array['1']; ?>--content"<?php print $content_attributes; ?>>
  <?php
